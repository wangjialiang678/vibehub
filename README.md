...
面向 Vibe Coding 教学、主题征集和 AI 黑客松场景的中心化管理、审核、部署与展示平台。学员用邀请码把自己习惯的 AI 工具（Claude Code / Codex / WorkBuddy）连上平台，写完一句 `vibehub deploy` 就能拿到预览地址；老师在审核队列里预览、通过或退回；通过的作品拿到自己的网址和二维码，并汇入课程作品集合页。

> 状态：**设计阶段**。产品需求与架构设计已完成，尚未开始编码。
